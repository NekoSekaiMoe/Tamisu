...
private val CUSTOM_USER_AGENT = "Tamisu/2.0 (Linux; Android ${Build.VERSION.RELEASE}; ${Build.MODEL})"
...
fun checkNewVersion(): LatestVersionInfo {
    val url = "https://api.github.com/repos/NekoSekaiMoe/Tamisu/releases/latest"
    ...
    return runCatching {
        ...
        client.newCall(request).execute().use { response ->
            ...
            for (i in 0 until assets.length()) {
                ...
                val regex = Regex("Tamisu.*_(\\d+)-release")
