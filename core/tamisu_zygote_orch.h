...
/*
 * Tamisu Zygisk - kernel-side orchestrator: per-app process lifecycle state
 * machine.
 *
 * Author: Anatdx
 */
#ifndef __TAMISU_H_ZYGOTE_ORCH
#define __TAMISU_H_ZYGOTE_ORCH
...
#endif // #ifndef __TAMISU_H_ZYGOTE_ORCH
