...
tamisu_set_fixmap_offset(enum fixed_addresses idx, phys_addr_t phys)
{
...
static TAMISU_INDIRECT_CALL void tamisu_clear_fixmap(enum fixed_addresses idx)
{
	typedef void (*fn_t)(enum fixed_addresses, phys_addr_t, pgprot_t);
	static fn_t fn;
...
static TAMISU_INDIRECT_CALL int tamisu_patch_text_nosync(void *dst, void *src,
