...
TAMISU_INDIRECT_CALL struct file *
...
TAMISU_INDIRECT_CALL void *tamisu_symtab_search(struct symtab *s,
						const char *name)
{
...
TAMISU_INDIRECT_CALL int tamisu_symtab_insert(struct symtab *s, char *name,
					      void *datum)
{
...
TAMISU_INDIRECT_CALL int
tamisu_hashtab_insert(struct hashtab *h, void *key, void *datum,
...
TAMISU_INDIRECT_CALL struct avtab_node *
tamisu_avtab_search_node(struct avtab *h, const struct avtab_key *key)
{
...
TAMISU_INDIRECT_CALL int tamisu_avtab_alloc(struct avtab *h, u32 nrules)
{
...
TAMISU_INDIRECT_CALL void tamisu_avtab_destroy(struct avtab *h)
{
...
TAMISU_INDIRECT_CALL int
tamisu_ebitmap_set_bit(struct ebitmap *e, tamisu_ebitmap_bit_t bit, int value)
{
...
TAMISU_INDIRECT_CALL struct filename_trans_datum *
...
TAMISU_INDIRECT_CALL void tamisu_policydb_destroy(struct policydb *p)
{
...
TAMISU_INDIRECT_CALL struct context *tamisu_sidtab_search(struct sidtab *s,
							  u32 sid)
{
...
TAMISU_INDIRECT_CALL void tamisu_selinux_policyload_notify(u32 seqno)
{
